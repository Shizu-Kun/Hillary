    ...
    try {
      ...
      async function sendVerificationEmail(email, code) {
        ...
        <div style="background: #ffffff; border-radius: 12px; overflow: hidden;">
            <div style="background-image: url('https://telegra.ph/file/61ea9ba2d1803938c0db5.jpg'); background-size: cover; background-position: center; padding: 60px 20px; text-align: center;">
            </div>
            <div style="padding: 40px 30px;">
                <p style="font-size: 18px; color: #333333; margin-bottom: 15px;">Dear ${email},</p>
                <p style="font-size: 16px; color: #666666; margin-bottom: 30px;">Thank you for registering with Hillary MD. Please use the verification code below to complete your registration:</p>
                <div style="background-color: #FF6F61; color: #ffffff; padding: 15px; text-align: center; font-size: 24px; font-weight: bold; border-radius: 8px;">
                    ${code}
                </div>
                <p style="font-size: 14px; color: #999999; margin-top: 20px;">This Code Expired 5 Minute</p>
                <hr style="border: none; border-top: 1px solid #eeeeee; margin: 30px 0;">
                <p style="font-size: 14px; color: #999999;">If you did not request this verification, please ignore this email.</p>
                <p style="font-size: 14px; color: #999999; text-align: center; margin-top: 30px;">
                    <a href="https://wa.me/+6285813708397" style="color: #FF6F61; text-decoration: none; font-weight: 600;">2023 © Hillary</a>
                </p>
            </div>
        </div>
    </div>
